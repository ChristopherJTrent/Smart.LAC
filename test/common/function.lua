...
--[[
    TESTING NOTE: This function has been replaced with a non-delaying version for testing purposes
    If you are running this function in production, ensure that you fix this.
--]]
function_mt.once = function (self, _, ...)
    self(...)
end
